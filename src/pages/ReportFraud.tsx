      ...
      <main id="main-content" className="flex-1 mt-20">
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-2xl mx-auto">
            ...
            {status === "success" && (
              <div role="status" className="mb-6 flex items-start gap-3 rounded-lg border border-green-200 bg-green-50 p-4 text-green-800">
            ...
            {status === "error" && serverError && (
              <div role="alert" className="mb-6 flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 p-4 text-red-800">
            ...
            <form onSubmit={handleSubmit} noValidate className="card p-6 sm:p-8 space-y-6">
              <div>
                <label htmlFor="impostorDetails" className="block text-sm font-medium text-foreground mb-1.5">
                ...
                {errors.impostorDetails && (
                  <p className="mt-1.5 text-sm text-red-600">{errors.impostorDetails}</p>
                )}
              </div>

              <div>
                <label htmlFor="contactInfo" className="block text-sm font-medium text-foreground mb-1.5">
                ...
                />
                {errors.contactInfo && (
                  <p className="mt-1.5 text-sm text-red-600">{errors.contactInfo}</p>
                )}
              </div>

              <div>
                <label htmlFor="comments" className="block text-sm font-medium text-foreground mb-1.5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <Link to="/reportes" className="btn btn-secondary btn-md gap-2 justify-center">
